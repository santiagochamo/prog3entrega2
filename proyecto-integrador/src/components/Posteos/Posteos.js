  ...
  return (
    <View>
      <FlatList
        ...
        renderItem={({ item }) => <Post data={ item } /> }/*y por cada item (posteo) vamos a renderizar el componente Post, que por la prop data va a acceder a los atributos necesarios de el posteo especifico*/
      />
    </View>
  )
}